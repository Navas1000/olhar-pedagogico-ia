...
public class CadastrarUnidadeRepositoryAdapterTest {
    ...
    @InjectMocks
    private CadastrarUnidadeRepositoryAdapter cadastrarUnidadeRepositoryAdapter;
    ...
    void deveCadastrarUnidadeComSucesso() {
        ...
        final UnidadeDto resposta = cadastrarUnidadeRepositoryAdapter.cadastrar(unidadeDto);

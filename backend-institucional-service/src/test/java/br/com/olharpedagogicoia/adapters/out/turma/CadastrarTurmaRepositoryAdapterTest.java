...
public class CadastrarTurmaRepositoryAdapterTest {
    ...
    @InjectMocks
    private CadastrarTurmaRepositoryAdapter cadastrarTurmaRepositoryAdapter;
    ...
    void deveCadastrarTurmaComSucesso() {
        ...
        final TurmaDto resposta = cadastrarTurmaRepositoryAdapter.cadastrar(turmaDto);

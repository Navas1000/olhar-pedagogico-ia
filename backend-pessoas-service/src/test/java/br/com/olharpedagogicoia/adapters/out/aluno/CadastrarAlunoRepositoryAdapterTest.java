...
public class CadastrarAlunoRepositoryAdapterTest {
    ...
    @InjectMocks
    private CadastrarAlunoRepositoryAdapter cadastrarAlunoRepositoryAdapter;
    ...
    void deveCadastrarAlunoComSucesso() {
        ...
        final AlunoDTO resposta = cadastrarAlunoRepositoryAdapter.cadastrar(alunoDTO);

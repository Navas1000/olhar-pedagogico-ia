...
public class AtualizarPessoaRepositoryAdapterTest {
    ...
    @InjectMocks
    private AtualizarPessoaRepositoryAdapter atualizarPessoaRepositoryAdapter;
    ...
    void deveAtualizarPessoaComSucesso() {
        ...
        final PessoaDTO resposta = atualizarPessoaRepositoryAdapter.atualizar(pessoaDTO);

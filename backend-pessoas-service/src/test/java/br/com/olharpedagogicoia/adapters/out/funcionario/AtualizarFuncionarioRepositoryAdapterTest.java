...
public class AtualizarFuncionarioRepositoryAdapterTest {
    ...
    @InjectMocks
    private AtualizarFuncionarioRepositoryAdapter atualizarFuncionarioRepositoryAdapter;
    ...
    void deveAtualizarFuncionarioComSucesso() {
        ...
        final FuncionarioDTO resposta = atualizarFuncionarioRepositoryAdapter.atualizar(funcionarioDTO);

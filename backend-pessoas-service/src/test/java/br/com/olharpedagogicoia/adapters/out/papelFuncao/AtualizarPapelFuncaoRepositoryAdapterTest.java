...
public class AtualizarPapelFuncaoRepositoryAdapterTest {
    ...
    @InjectMocks
    private AtualizarPapelFuncaoRepositoryAdapter atualizarPapelFuncaoRepositoryAdapter;

    @Test
    void deveAtualizarPapelFuncaoComSucesso() {
        ...
        final PapelFuncaoDTO resposta = atualizarPapelFuncaoRepositoryAdapter.atualizar(papelFuncaoDTO);

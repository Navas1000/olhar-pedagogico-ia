...
public class AtualizarProfessorTurmaRepositoryAdapterTest {
    ...
    @InjectMocks
    private AtualizarProfessorTurmaRepositoryAdapter atualizarProfessorTurmaRepositoryAdapter;
    ...
    void deveAtualizarProfessorTurmaComSucesso() {
        ...
        final ProfessorTurmaDTO resposta = atualizarProfessorTurmaRepositoryAdapter.atualizar(professorTurmaDTO);

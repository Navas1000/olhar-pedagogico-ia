...
public class CadastrarAlunoTurmaRepositoryAdapterTest {
    ...
    @InjectMocks
    private CadastrarAlunoTurmaRepositoryAdapter cadastrarAlunoTurmaRepositoryAdapter;
    ...
    void deveCadastrarAlunoTurmaComSucesso() {
        ...
        final AlunoTurmaDTO resposta = cadastrarAlunoTurmaRepositoryAdapter.cadastrar(alunoTurmaDTO);

...
public class CadastrarDiarioEducacionalRepositoryAdapterTest {
    ...
    @InjectMocks
    private CadastrarDiarioEducacionalRepositoryAdapter cadastrarDiarioEducacionalRepositoryAdapter;
    ...
    void deveCadastrarDiarioEducacionalComSucesso() {
        ...
        final DiarioEducacionalDTO resposta =
                cadastrarDiarioEducacionalRepositoryAdapter.cadastrar(diarioEducacionalDTO);

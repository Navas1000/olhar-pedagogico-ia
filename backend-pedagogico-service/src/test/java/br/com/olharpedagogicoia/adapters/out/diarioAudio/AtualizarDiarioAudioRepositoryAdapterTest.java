...
public class AtualizarDiarioAudioRepositoryAdapterTest {
    ...
    @InjectMocks
    private AtualizarDiarioAudioRepositoryAdapter atualizarDiarioAudioRepositoryAdapter;
    ...
    void deveAtualizarDiarioAudioComSucesso() {
        ...
        final DiarioAudioDTO resposta =
                atualizarDiarioAudioRepositoryAdapter.atualizar(diarioAudioDTO);

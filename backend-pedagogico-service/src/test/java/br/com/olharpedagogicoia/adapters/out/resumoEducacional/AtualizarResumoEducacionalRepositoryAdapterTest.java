...
public class AtualizarResumoEducacionalRepositoryAdapterTest {
    ...
    @InjectMocks
    private AtualizarResumoEducacionalRepositoryAdapter atualizarResumoEducacionalRepositoryAdapter;
    ...
    void deveAtualizarResumoEducacionalComSucesso() {
        ...
        final ResumoEducacionalDTO resposta =
                atualizarResumoEducacionalRepositoryAdapter.atualizar(resumoEducacionalDTO);

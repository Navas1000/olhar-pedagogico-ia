...
public class AtualizarTranscricaoRepositoryAdapterTest {
    ...
    @InjectMocks
    private AtualizarTranscricaoRepositoryAdapter atualizarTranscricaoRepositoryAdapter;
    ...
    void deveAtualizarTranscricaoComSucesso() {
        ...
        final TranscricaoDTO resposta =
                atualizarTranscricaoRepositoryAdapter.atualizar(transcricaoDTO);
